...
function HaveHover() {
    ...
    for (var i = 0; i < allcolor.length; i++) {
        for (var n = 1; n <= 4; n++) {
            ...
            console.log(allcolor[i] + "pawn" + n)
            console.log(currpawn)
            console.log(firstPawn.style.top, firstPawn.style.left, secondPawn.style.top, secondPawn.style.left, currcolor, allcolor[i], currPos, num)
